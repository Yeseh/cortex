...
import { FilesystemRegistry, FilesystemStorageAdapter } from '../core/storage/filesystem/index.ts';
import type { RegistryError, ScopedStorageAdapter, StoreNotFoundError } from '../core/storage/adapter.ts';
