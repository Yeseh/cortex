...
describe('Cortex CLI Integration Tests', () => {
    ...
    describe('prune command', () => {
        ...
        it('should report when no expired memories found', async () => {
            ...
            await createCategoryIndex(testStore, 'project', [{ path: 'project/fresh-memory', tokenEstimate: 10 }]);
