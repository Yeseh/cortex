...
describe('store CLI commands', () => {
    ...
    it('should add a store and persist the registry', async () => {
        ...
        const expectedPath = resolve('C:/Stores/Primary');
        expect(result.value.output).toEqual({
            kind: 'store',
            value: { name: 'primary', path: expectedPath },
        });
    ...
    it('should resolve relative paths with dot prefix', async () => {
        ...
        const expectedPath = resolve(tempDir, 'my-store');
        expect(result.value.output).toEqual({
            kind: 'store',
            value: { name: 'relative-store', path: expectedPath },
        });
    });
    ...
    it('should resolve relative paths with parent directory', async () => {
        ...
        const expectedPath = resolve(tempDir, '../sibling-store');
        expect(result.value.output).toEqual({
            kind: 'store',
            value: { name: 'parent-store', path: expectedPath },
        });
    });
    ...
    it('should resolve implicit relative paths', async () => {
        ...
        const expectedPath = resolve(tempDir, 'path/without/slash');
        expect(result.value.output).toEqual({
            kind: 'store',
            value: { name: 'implicit-store', path: expectedPath },
        });
    });
    ...
    it('should expand tilde to home directory', async () => {
        ...
        const expectedPath = resolve(homedir(), 'my-memories');
        expect(result.value.output).toEqual({
            kind: 'store',
            value: { name: 'home-store', path: expectedPath },
        });
    });
    ...
    it('should expand standalone tilde to home directory', async () => {
        ...
        expect(result.value.output).toEqual({
            kind: 'store',
            value: { name: 'home-root', path: expectedPath },
        });
    });
    ...
    it('should preserve Unix absolute paths unchanged', async () => {
        ...
        const expectedPath = resolve('/absolute/unix/path');
        expect(result.value.output).toEqual({
            kind: 'store',
            value: { name: 'unix-store', path: expectedPath },
        });
    });
    ...
    it('should preserve Windows absolute paths unchanged', async () => {
        ...
        const expectedPath = resolve('D:/Windows/Store');
        expect(result.value.output).toEqual({
            kind: 'store',
            value: { name: 'windows-store', path: expectedPath },
        });
    });
});
