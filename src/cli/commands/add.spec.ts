...
describe('add CLI command', () => {
    ...
    beforeEach(async () => {
        tempDir = await mkdtemp(join(tmpdir(), 'cortex-add-cli-'));
    });
    ...
    describe('success cases', () => {
        it('should add memory with --content flag', async () => {
            const now = new Date('2024-01-15T10:00:00.000Z');
            const result = await runAddCommand(
                buildOptions(['project/test-memory', '--content', 'Hello, world!'], { now })
            );
        ...
        it('should add memory with --tags flag', async () => {
        ...
        it('should add memory with --expires-at flag', async () => {
        ...
        it('should add memory with all flags combined', async () => {
        ...
        it('should handle deeply nested category paths', async () => {
            const now = new Date('2024-01-01T00:00:00.000Z');
            const result = await runAddCommand(
                buildOptions(['a/b/c/d/deep-memory', '--content', 'Deep content'], { now })
            );
        ...
        it('should handle empty tags list', async () => {
            const now = new Date('2024-01-01T00:00:00.000Z');
            const result = await runAddCommand(
                buildOptions(['project/no-tags', '--content', 'No tags', '--tags', ''], { now })
            );
        ...
        it('should handle multiline content', async () => {
            ...
            const result = await runAddCommand(
                buildOptions(['project/multiline', '--file', inputPath], { now })
            );
        ...
        it('should trim tag values', async () => {
            ...
            const result = await runAddCommand(
                buildOptions(
                    ['project/trimmed-tags', '--content', 'Content', '--tags', ' foo , bar '],
                    { now }
                )
            );
    ...
    describe('error cases', () => {
        it('should return INVALID_ARGUMENTS when memory path is missing', async () => {
            const result = await runAddCommand(buildOptions(['--content', 'Hello']));
        ...
        it('should return INVALID_ARGUMENTS when --content flag has no value', async () => {
            const result = await runAddCommand(buildOptions(['project/memory', '--content']));
        ...
        it('should return INVALID_ARGUMENTS when --file flag has no value', async () => {
            const result = await runAddCommand(buildOptions(['project/memory', '--file']));
        ...
        it('should return INVALID_ARGUMENTS when --tags flag has no value', async () => {
            const result = await runAddCommand(
                buildOptions(['project/memory', '--content', 'Hello', '--tags'])
            );
        ...
        it('should return INVALID_ARGUMENTS when --expires-at flag has no value', async () => {
            const result = await runAddCommand(
                buildOptions(['project/memory', '--content', 'Hello', '--expires-at'])
            );
        ...
        it('should return INVALID_ARGUMENTS for invalid expires-at timestamp', async () => {
            const result = await runAddCommand(
                buildOptions(['project/memory', '--content', 'Hello', '--expires-at', 'not-a-date'])
            );
        ...
        it('should return INVALID_ARGUMENTS for tags with empty parts', async () => {
            const result = await runAddCommand(
                buildOptions(['project/memory', '--content', 'Hello', '--tags', 'foo,,bar'])
            );
        ...
        it('should return CONTENT_INPUT_FAILED when no content source is provided', async () => {
            const result = await runAddCommand(
                buildOptions(['project/memory'], { stdin: createTtyStdin() })
            );
        ...
        it('should return CONTENT_INPUT_FAILED when file does not exist', async () => {
            const result = await runAddCommand(
                buildOptions(['project/memory', '--file', '/nonexistent/file.txt'])
            );
    ...
    describe('edge cases', () => {
        it('should ignore empty string arguments', async () => {
            const now = new Date('2024-01-01T00:00:00.000Z');
            const result = await runAddCommand(
                buildOptions(['', 'project/memory', '', '--content', 'Hello', ''], { now })
            );
        ...
        it('should handle content with special characters', async () => {
            ...
            const result = await runAddCommand(
                buildOptions(['project/special', '--content', specialContent], { now })
            );
        ...
        it('should handle very long content', async () => {
            ...
            const result = await runAddCommand(
                buildOptions(['project/long-content', '--file', inputPath], { now })
            );
        ...
        it('should handle slug path with normalized segments', async () => {
