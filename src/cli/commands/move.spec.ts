    ...
    'move CLI command', () => {
        ...
        const createMemoryFile = async (slugPath: string) => {
            ...
            const memoryDir = join(
                storeRoot, 'memories', ...segments.slice(
                    0, -1,
                ),
            );
            await mkdir(
        ...
        const createCategory = async (categoryPath: string) => {
            const dir = join(
                storeRoot, 'memories', ...categoryPath.split('/'),
            );
            await mkdir(
                dir, { recursive: true },
            );
        ...
        describe(
            'success cases', () => {
                it(
                    'should move memory to existing destination category', async () => {
                ...
                it(
                    'should move memory to nested destination category', async () => {
                ...
                it(
                    'should move memory with different slug name at destination', async () => {
        ...
        describe(
            'argument validation errors', () => {
                ...
                it(
                    'should return INVALID_ARGUMENTS when only one argument provided', async () => {
                ...
                it(
                    'should return INVALID_ARGUMENTS when unknown flag is provided', async () => {
                        const result = await runMoveCommand(buildOptions([
                            '--verbose',
                ...
                it(
                    'should return INVALID_ARGUMENTS when too many arguments provided', async () => {
                        const result = await runMoveCommand(buildOptions([
                            'source/memory',
                            'dest/memory',
                            'extra-argument',
                ...
                it(
                    'should return INVALID_ARGUMENTS for short flags', async () => {
                        const result = await runMoveCommand(buildOptions([
                            '-f',
                            'source/memory',
                            'dest/memory',
        ...
        describe(
            'move operation errors', () => {
                ...
                it(
                    'should return MOVE_FAILED when source memory does not exist', async () => {
                ...
                it(
                    'should return MOVE_FAILED when nested destination category does not exist', async () => {
                        await createMemoryFile('source/memory');
        ...
        describe(
            'edge cases', () => {
                ...
                it(
                    'should filter out empty arguments', async () => {
