...
describe(
    'remove CLI command', () => {
        ...
        const createMemoryFile = async (
            storeRoot: string, slugPath: string,
        ) => {
            const content = [
                '---',
        ...
        describe(
            'success cases', () => {
                it(
                    'should remove an existing memory', async () => {
                ...
                it(
                    'should be idempotent when removing non-existent memory', async () => {
                ...
                it(
                    'should remove memory with deep category path', async () => {
        ...
        describe(
            'error cases', () => {
                ...
                it(
                    'should return INVALID_PATH for slug path missing category', async () => {
                ...
                it(
                    'should return INVALID_PATH for trailing slash in path', async () => {
                ...
                it(
                    'should return INVALID_PATH for slug path with invalid characters', async () => {
