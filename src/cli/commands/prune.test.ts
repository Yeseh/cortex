...
describe("runPruneCommand", () => {
  ...
  test("deletes expired memories", async () => {
    ...
    const memoryPath = join(TEST_ROOT, "memories", "project", "expired-memory.md");
  ...
  test("keeps non-expired memories", async () => {
    ...
    const expiredPath = join(TEST_ROOT, "memories", "project", "expired-memory.md");
    const activePath = join(TEST_ROOT, "memories", "project", "active-memory.md");
