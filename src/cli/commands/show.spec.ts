...
describe(
    'show CLI command', () => {
        ...
        const createMemoryFile = async (
            storeRoot: string, slugPath: string, content: string,
        ) => {
            const memoryDir = join(
                storeRoot, 'memories', ...slugPath.split('/').slice(
                    0, -1,
                ),
            );
            await mkdir(
            ...
            const filePath = join(
                storeRoot, 'memories', `${slugPath}.md`,
            );
            await writeFile(
        ...
        describe(
            'success cases', () => {
                it(
                    'should show existing memory with all frontmatter fields', async () => {
                        ...
                        await createMemoryFile(
                            tempDir, slugPath, memoryContent,
                        );
                ...
                it(
                    'should show memory with optional expiresAt field', async () => {
                ...
                it(
                    'should show memory without expiresAt field', async () => {
                        ...
                        expect(memory.metadata.tags).toEqual([ 'permanent',
                            'important' ]);
                ...
                it(
                    'should include token estimate in metadata', async () => {
                ...
                it(
                    'should handle empty tags array', async () => {
        ...
        describe(
            'error cases', () => {
                it(
                    'should return INVALID_ARGUMENTS when args are empty', async () => {
                ...
                it(
                    'should return INVALID_ARGUMENTS for short unknown flag', async () => {
                ...
                it(
                    'should normalize empty path segments and return MEMORY_NOT_FOUND', async () => {
                ...
                it(
                    'should return PARSE_FAILED for malformed memory file (missing frontmatter)', async () => {
                        const slugPath = 'project/malformed-memory';
                        const malformedContent = 'This file has no frontmatter at all.';

                        await createMemoryFile(
                            tempDir, slugPath, malformedContent,
                        );
                ...
                it(
                    'should return PARSE_FAILED for unclosed frontmatter', async () => {
                ...
                it(
                    'should return PARSE_FAILED for missing required field (created_at)', async () => {
                ...
                it(
                    'should return PARSE_FAILED for missing required field (source)', async () => {
                ...
                it(
                    'should return PARSE_FAILED for invalid timestamp format', async () => {
                ...
                it(
                    'should return PARSE_FAILED for invalid tags format', async () => {
        ...
        describe(
            'edge cases', () => {
                it(
                    'should handle empty content body', async () => {
                ...
                it(
                    'should return INVALID_PATH for whitespace-only slug path argument', async () => {
                ...
                it(
                    'should normalize trailing slashes and return MEMORY_NOT_FOUND', async () => {
                ...
                it(
                    'should handle tags with special characters', async () => {
                        ...
                        expect(result.value.output.value.metadata.tags).toEqual([ 'tag-with-dash',
                            'tag.with.dots' ]);
                    },
                );

                it(
                    'should handle memory with list-style tags', async () => {
                        ...
                        expect(result.value.output.value.metadata.tags).toEqual([ 'first-tag',
                            'second-tag' ]);
                    },
                );
            },
