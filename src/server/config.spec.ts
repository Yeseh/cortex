    ...
    // Store original env
        ...
        describe(
            'default values', () => {
                ...
                it(
                    'should return all default fields in the config object', () => {
                        const result = loadServerConfig();
        ...
        describe(
            'environment variable parsing', () => {
                ...
                it(
                    'should read CORTEX_DEFAULT_STORE', () => {
                ...
                it(
                    'should read CORTEX_OUTPUT_FORMAT', () => {
                ...
                it(
                    'should read CORTEX_AUTO_SUMMARY_THRESHOLD', () => {
                ...
                it(
                    'should coerce string port value to number', () => {
                ...
                it(
                    'should coerce string threshold value to number', () => {
                ...
                it(
                    'should parse multiple env vars together', () => {
                ...
                it(
                    'should accept zero for autoSummaryThreshold', () => {
        ...
        describe(
            'output format validation', () => {
                it(
                    'should accept yaml output format', () => {
        ...
        describe(
            'validation errors', () => {
                ...
                it(
                    'should reject invalid logLevel', () => {
                ...
                it(
                    'should reject invalid outputFormat', () => {
                ...
                it(
                    'should reject negative autoSummaryThreshold', () => {
                ...
                it(
                    'should reject non-integer autoSummaryThreshold', () => {
                ...
                it(
                    'should reject non-numeric autoSummaryThreshold', () => {
                ...
                it(
                    'should include issues array in validation error', () => {
                        process.env.CORTEX_PORT = '-1';
        ...
        describe(
            'result type structure', () => {
                it(
                    'should return ok: true with value on success', () => {
                        const result = loadServerConfig();
                ...
                it(
                    'should return ok: false with error on failure', () => {
                ...
                it(
                    'should have error with code and message properties', () => {
                        process.env.CORTEX_PORT = 'invalid';
                        const result = loadServerConfig();
...
describe(
    'serverConfigSchema', () => {
        ...
        it(
            'should parse valid config directly', () => {
                const config = {
                    dataPath: '/path',
                    port: 5000,
                    host: 'localhost',
