...
describe(
    'store tool registration', () => {
        ...
        describe(
            'registerStoreTools function', () => {
                it(
                    'should register both tools without throwing', () => {
                        expect(() => registerStoreTools(
                            server, config,
                        )).not.toThrow(); 
                    },
                );
                ...
                it(
                    'should call registerTool with list_stores', () => {
                        ...
                        expect(registerToolCalls).toContain('list_stores');
                    },
                );

                it(
                    'should call registerTool with create_store', () => {
                        const registerToolCalls: string[] = [];
                        const originalRegisterTool = server.registerTool.bind(server);
                        ...
                        expect(registerToolCalls).toContain('create_store');
                    },
                );
                ...
                it(
                    'should register tools with descriptions', () => {
                        ...
                        const listStoresTool = registeredDescriptions.find((t) => t.name === 'list_stores');
                        const createStoreTool = registeredDescriptions.find((t) => t.name === 'create_store');
                ...
                it(
                    'should register create_store with input schema containing name field', () => {
        ...
        describe(
            'integration with MCP server', () => {
                it(
                    'should execute list_stores tool and return valid response when no stores exist', async () => {
                        registerStoreTools(
                            server, config,
                        );
                ...
                it(
                    'should execute list_stores tool and return stores when stores exist', async () => {
                        // Create some stores
                ...
                it(
                    'should execute create_store tool with valid name and create store', async () => {
                        registerStoreTools(
                            server, config,
                        );
                ...
                it(
                    'should execute create_store tool with invalid name and return error', async () => {
                        registerStoreTools(
                            server, config,
                        );
                ...
                it(
                    'should execute create_store tool with empty name and return error', async () => {
                        registerStoreTools(
                            server, config,
                        );
                ...
                it(
                    'should execute create_store tool with existing store name and return error', async () => {
                ...
                it(
                    'should return error from list_stores when data path is a file', async () => {
        ...
        describe(
            'tool handler behavior', () => {
                it(
                    'should return JSON formatted response from list_stores', async () => {
                        registerStoreTools(
                            server, config,
                        );
                ...
                it(
                    'should return JSON formatted response from create_store', async () => {
                        registerStoreTools(
                            server, config,
                        );
                ...
                it(
                    'should create store with special valid characters in name', async () => {
                        registerStoreTools(
                            server, config,
                        );
                ...
                it(
                    'should handle name with special invalid characters', async () => {
                        registerStoreTools(
                            server, config,
                        );
