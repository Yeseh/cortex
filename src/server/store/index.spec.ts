...
describe('store tool registration', () => {
    ...
    describe('registerStoreTools function', () => {
        ...
        it('should call registerTool with list_stores', () => {
        ...
        it('should call registerTool with create_store', () => {
            const registerToolCalls: string[] = [];
            const originalRegisterTool = server.registerTool.bind(server);
        ...
        it('should register tools with descriptions', () => {
            const registeredDescriptions: Array<{ name: string; description: string }> = [];
            const originalRegisterTool = server.registerTool.bind(server);
