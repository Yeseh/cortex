...
export const parseStoreRegistry = (
  raw: string
): Result<StoreRegistry, StoreRegistryParseError> => {
...
export type StoreRegistrySaveErrorCode =
...
export const serializeStoreRegistry = (
  registry: StoreRegistry
): Result<string, StoreRegistrySerializeError> => {
...
export const removeStoreRegistry = async (
  path: string
): Promise<Result<void, StoreRegistrySaveError>> => {
  try {
