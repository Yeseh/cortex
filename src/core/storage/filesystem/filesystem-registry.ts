...
import type { Registry, RegistryError, ScopedStorageAdapter, StoreNotFoundError } from '../adapter.ts';
import type { StoreRegistry } from '../../store/registry.ts';
import { parseStoreRegistry, serializeStoreRegistry } from '../../store/registry.ts';
