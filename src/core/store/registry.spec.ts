...
describe('description field parsing', () => {
    it('should parse description after path', () => {
        const raw = [
            'stores:',
            '  default:',
            '    path: "/data/default"',
    ...
    it('should parse description before path', () => {
        const raw = [
            'stores:',
            '  default:',
            '    description: "Default store for general memories"',
    ...
    it('should parse registry with empty description', () => {
        const raw = [
            'stores:',
            '  default:',
            '    path: "/data/default"',
    ...
    it('should parse registry with quoted description containing special chars', () => {
        const raw = [
            'stores:',
            '  default:',
            '    path: "/data/default"',
    ...
    it('should parse multiple stores with mixed descriptions', () => {
        const raw = [
            'stores:',
            '  default:',
            '    path: "/data/default"',
    ...
    it('should reject duplicate description entries', () => {
        const raw = [
            'stores:',
            '  default:',
            '    path: "/data/default"',
    ...
    it('should reject description without store context', () => {
        const raw = [
...
describe('description field serialization', () => {
    it('should serialize registry with description', () => {
        const registry = {
    ...
    it('should serialize registry without description', () => {
        const registry = {
    ...
    it('should round-trip registry with descriptions', () => {
        const original = {
...
describe('resolveStorePath', () => {
    it('should return path for registered store', () => {
        const registry = {
            default: { path: '/data/default' },
    ...
    it('should work with stores that have descriptions', () => {
        const registry = {
            default: { path: '/data/default', description: 'The default store' },
        };
