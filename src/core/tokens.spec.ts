...
describe('token estimation', () => {
    describe('estimateTokensHeuristicV1', () => {
    ...
    describe('heuristicTokenizerV1', () => {
        it('should implement Tokenizer interface', () => {
            const tokenizer: Tokenizer = heuristicTokenizerV1;

            expect(typeof tokenizer.estimateTokens).toBe('function');
        });

        it('should delegate to estimateTokensHeuristicV1', () => {
    ...
    describe('defaultTokenizer', () => {
        ...
        it('should be the same as heuristicTokenizerV1', () => {
