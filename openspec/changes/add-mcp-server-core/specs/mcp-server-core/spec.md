...
Core MCP server infrastructure providing HTTP transport, configuration management, health monitoring, and error translation for exposing Cortex memory operations to AI agents.
