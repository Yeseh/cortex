...
Core business logic for category operations, providing pure functions for category management with an abstract storage port for testability and future backend flexibility.
