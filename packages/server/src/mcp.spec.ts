...
describe('MCP server setup', () => {
    ...
    describe('createMcpTransport', () => {
        it('should return a WebStandardStreamableHTTPServerTransport instance', () => {
    ...
    describe('createMcpContext', () => {
        it('should return an object with server and transport properties', () => {
        ...
        it('should return an McpServer instance as server', () => {
            const context = createMcpContext();

            expect(context.server).toBeInstanceOf(McpServer);
        });

        it('should return a WebStandardStreamableHTTPServerTransport instance as transport', () => {
            const context = createMcpContext();
    ...
    describe('server-transport integration', () => {
        it('should allow connecting server to transport', async () => {
            const context = createMcpContext();
