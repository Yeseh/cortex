...
describe(
    'MemoryPath', () => {
        describe(
            'fromPath', () => {
                it(
                    'should parse category and slug segments', () => {
                ...
                it(
                    'should ignore empty path segments', () => {
                        const result = MemoryPath.fromPath('/project//alpha/');
                ...
                it(
                    'should reject paths with fewer than two segments', () => {
        ...
        describe(
            'fromSegments', () => {
                it(
                    'should reject when fewer than two segments are provided', () => {
                ...
                it(
                    'should reject invalid category path segments', () => {
                ...
                it(
                    'should reject invalid slug segment', () => {
