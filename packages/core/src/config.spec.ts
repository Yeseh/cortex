...
describe(
    'config parsing', () => {
        ...
        it(
            'should reject unsupported fields', () => {
        ...
        it(
            'should reject non-integer auto_summary_threshold', () => {
        ...
        it(
            'should reject negative auto_summary_threshold values', () => {
...
describe(
    'config loading', () => {
        ...
        it(
            'should prefer local config values over global config', async () => {
                const globalPath = join(
                    tempDir, 'global-config.yaml',
                );
                const localPath = join(
                    tempDir, '.cortex', 'config.yaml',
                );
